...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || '5s6_nfa1a@tempmail.cn',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/mark0four/',
    },
    {
      name: 'Blog',
      link: 'https://markfour.tk',
    },
  ],
